...
class ImageLoader(data.Dataset):
  ...
  def load_imagepaths_with_labels(self, class_labels) -> List[Tuple[str, int]]:
    ...
    for class_label in class_labels:
      for i in glob.glob(self.curr_folder + "/" + class_label + "/*.jpg"):
        img_paths.append((i, class_labels[class_label]))
  ...
  def get_classes(self) -> dict:
    ...
    data = os.listdir(self.curr_folder)
  ...
  def __getitem__(self, index: int) -> Tuple[torch.tensor, int]:
    ...
    img = self.transform(self.load_img_from_path(img))
